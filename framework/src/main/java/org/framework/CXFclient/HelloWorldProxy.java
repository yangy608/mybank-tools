...
public class HelloWorldProxy implements org.framework.CXFclient.HelloWorld {
  private String _endpoint = null;
  private org.framework.CXFclient.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new org.framework.CXFclient.HelloWorldImplServiceLocator()).getHelloWorldImplPort();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public org.framework.CXFclient.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
