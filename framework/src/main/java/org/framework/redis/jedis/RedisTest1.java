...
//        System.out.println(jedis.mget("name","jarorwar"));  
    ...
    public static void testList(){   
    	...
    	//String msg = "20130904110738┆20130904110728232001┆{||||F0001|0|130904110717254001|63e681aa6473ac3f81e927851ec3239e|000000|||0}{name|3|10}{T}";

        //开始前，先移除所有的内容   
//       jedis.del("mybank_statistics_stringing");   
       //mybank_message_stringing
    	
       // System.out.println(jedis.lrange("mybank_message_stringing",0,-1));   
       //先向key java framework中存放三条数据   
     // jedis.lpush("mybank_message_stringing",msg);   
//       jedis.lpush("java framework","struts");   
//       jedis.lpush("java framework","hibernate");   
       //再取出所有数据jedis.lrange是按范围取出，   
       // 第一个是key，第二个是起始位置，第三个是结束位置，jedis.llen获取长度 -1表示取得所有   

       List<String> list = jedis.lrange("mybank_message_stringing", 0, -1);
