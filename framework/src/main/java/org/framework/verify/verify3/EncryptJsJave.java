package org.framework.verify.verify3;

import java.util.ArrayList;
import java.util.List;

public class EncryptJsJave {
	...
	public static String encrypt(String data) {
		return encrypt(data, "key1", "key2", "key3").toLowerCase();
	}
	/**
	 * encrypt
	 * 
	...
	public static String decrypt(String data) {
		return decrypt(data.toUpperCase(), "key1", "key2", "key3");
	}
