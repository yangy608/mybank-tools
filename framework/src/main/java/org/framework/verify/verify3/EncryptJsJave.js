...
function encrypt(data) {
	return encrypt2(data, "key1", "key2", "key3").toLowerCase();
}

function decrypt(data) {
	return decrypt2(data.toUpperCase(), "key1", "key2", "key3").toLowerCase();
}

function encrypt2(data, firstKey, secondKey, thirdKey) {
...
function decrypt2(data, firstKey, secondKey, thirdKey) {
	var leng = data.length;
	var decStr = "";
	var firstKeyBt, secondKeyBt, thirdKeyBt, firstLength, secondLength, thirdLength;
	if (firstKey != null && firstKey != "") {
