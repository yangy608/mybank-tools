...
public class Base64 extends BaseNCodec
{
  ...
  public Base64(int lineLength, byte[] lineSeparator, boolean urlSafe)
  {
    ...
    if (lineSeparator != null) {
      if (containsAlphabetOrPad(lineSeparator)) {
        String sep = Base64Util.newStringUtf8(lineSeparator);
  ...
  {
    return isBase64(Base64Util.getBytesUtf8(base64));
  }
  ...
  {
    return Base64Util.newStringUtf8(encodeBase64(binaryData, false));
  }
  ...
  {
    return Base64Util.newStringUtf8(encodeBase64(binaryData, false, true));
  }
