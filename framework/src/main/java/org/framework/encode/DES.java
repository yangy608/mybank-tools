...
public class DES {
	 ...
	 */
	private static String strDefaultKey = "mybank99";
	...
	// [8][4][16]
	static final int ccom_SSS_p[][][] = { { { 14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7 }, { 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 }, { 4, 1, 14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0 }, { 15, 12, 8, 2, 4, 9, 1, 7, 5, 11, 3, 14, 10, 0, 6, 13 } },
	...
	public static String Encode(String str) throws UnsupportedEncodingException {
		...
		i1 = ENCRYPT(strDefaultKey.getBytes("gbk"), byte1, byte2, byte1.length);
		digestHexStr = "";
		for (int i = 0; i < i1; i++) {
	...
	public static String Decode(String str) throws UnsupportedEncodingException {
		...
		i2 = m.DECRYPT(m.strDefaultKey.getBytes("gbk"), byteMingW, byteMiW, byteMiW.length);

		BASE64Encoder base64encoder = new BASE64Encoder();
		return new String(byteMingW, 0, i2, "gbk");
	}
